...
train_model() {
  local solver=/mnt/lustre/yangkunlin/kaggle_camera/inceptionResNetV2/incepResV2/incepResV2_solver.prototxt
  local log=/mnt/lustre/yangkunlin/kaggle_camera/inceptionResNetV2/incepResV2/model/log/incepResV2.log
