...
MODELS_DIR=/mnt/lustre/yangkunlin/kaggle_camera/resnet101/resnet101
...
extract_features() {
  ...
  for num in 0 ; do
    ...
    local model=/mnt/lustre/yangkunlin/kaggle_camera/resnet50_pre/resnet50_sense/temp_Resnet101_test.prototxt
    local list=test${num}
    sed -e "s/\${list}/${list}/g" \
      ${MODELS_DIR}/Resnet101_test.prototxt > ${model}
    echo ${model}
...
trained_model=/mnt/lustre/yangkunlin/kaggle_camera/resnet101/resnet101/model_aug/resnet101_iter_209000.caffemodel
