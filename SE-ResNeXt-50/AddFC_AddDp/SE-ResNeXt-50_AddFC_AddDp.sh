...
train_model() {
  local solver=/mnt/lustre/yangkunlin/kaggle_camera/SE-ResNeXt-50/AddFC_AddDp/SE-ResNeXt-50_AddFC_AddDp_solver.prototxt
  local log=/mnt/lustre/yangkunlin/kaggle_camera/SE-ResNeXt-50/model_AddFC_AddDp/log/SE-ResNeXt-50_AddFC.log
  ...
  --mpi=pmi2 --gres=gpu:8 -n8 --ntasks-per-node=8 --job-name=sefcdp \
