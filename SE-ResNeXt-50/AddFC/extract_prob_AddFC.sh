...
# Some constants
CAFFE_DIR=/mnt/lustre/share/disparity_core
export PYTHONPATH=/mnt/lustre/share/disparity_core/python:$PYTHONPATH
MODELS_DIR=/mnt/lustre/yangkunlin/kaggle_camera/SE-ResNeXt-50
...
extract_features() {
  ...
  for num in 0 ; do
    ...
    local model=/mnt/lustre/yangkunlin/kaggle_camera/SE-ResNeXt-50/temp_SE-ResNeXt-50_AddFC_test.prototxt
    local list=test${num}
    sed -e "s/\${list}/${list}/g" \
      ${MODELS_DIR}/SE-ResNeXt-50_AddFC_test.prototxt > ${model}
    echo ${model}
...
trained_model=/mnt/lustre/yangkunlin/kaggle_camera/SE-ResNeXt-50/model_AddFC/SE-ResNeXt-50_AddFC_iter_60000.caffemodel
