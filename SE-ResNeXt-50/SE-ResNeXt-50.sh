...
train_model() {
  local solver=/mnt/lustre/yangkunlin/kaggle_camera/SE-ResNeXt-50/SE-ResNeXt-50_solver.prototxt
  local log=/mnt/lustre/yangkunlin/kaggle_camera/SE-ResNeXt-50/model/log/SE-ResNeXt-50.log
