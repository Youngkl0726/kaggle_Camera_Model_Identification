...
train_model() {
  local solver=/mnt/lustre/yangkunlin/kaggle_camera/resnet50/model_train_val/resnet50_sensenet_AddFC_solver.prototxt
  local log=/mnt/lustre/yangkunlin/kaggle_camera/resnet50/model_train_val/model_sensenet_AddFC/log/resnet50_sensenet.log
