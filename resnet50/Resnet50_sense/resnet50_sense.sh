...
train_model() {
  local solver=/mnt/lustre/yangkunlin/kaggle_camera/resnet50_pre/resnet50_sense/Resnet50_sense_solver.prototxt
  local log=/mnt/lustre/yangkunlin/kaggle_camera/resnet50_pre/resnet50_sense/model/log/resnet50_sense.log
