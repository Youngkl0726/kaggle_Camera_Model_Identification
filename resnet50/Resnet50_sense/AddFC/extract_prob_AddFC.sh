...
extract_features() {
  ...
  for num in 0 ; do
    ...
    local model=/mnt/lustre/yangkunlin/kaggle_camera/resnet50_pre/resnet50_sense/temp_Resnet50_sense_AddFC_test.prototxt
    local list=test${num}
    sed -e "s/\${list}/${list}/g" \
      ${MODELS_DIR}/Resnet50_sense_AddFC_test.prototxt > ${model}
    echo ${model}
...
trained_model=/mnt/lustre/yangkunlin/kaggle_camera/resnet50_pre/resnet50_sense/model_AddFC/resnet50_sense_iter_15000.caffemodel
